...
tags:
  ...
  - group-theory
created: 2026-01-19
source: "Serge Lang, Algebra, rev. 3rd ed., Ch. VI, §15, printed pp. 318–319, PDF pp. 333–334; Ch. XIII, Exercises 18–21, printed p. 547, PDF p. 562"
...
Lang uses $\mathrm{SL}_2(\mathbb Z)$ and its fractional-linear action on the upper half-plane in the modular-form definition; the cited exercises treat reduction modulo $N$ and generation of $\mathrm{SL}_2(\mathbb Z)$ by the standard elementary matrices. This supports the group/action/generator core. The quotient presentation $\mathrm{PSL}_2(\mathbb Z)\cong C_2*C_3$, stabilizer analysis, orbifold language, and geometric fundamental-domain claims are not proved in those slices.
