...
tags:
  - exercise
  - group-theory
source: "Michael Artin, Algebra, 2nd ed., Ch. 7, Section 7, Ex. 7.10, printed p. 224, PDF p. 236; Serge Lang, Algebra, rev. 3rd ed., Ch. I, Groups, Exercise 27, printed p. 77, PDF p. 92"
created: 2026-08-27
---
...
> [!question] Lang Exercise 27
> Show that every group of order less than $60$ is solvable.
...
> [!success]- Lang Exercise 27
> Proceed by induction on $|G|<60$. Prime-order groups are cyclic and hence solvable. If $|G|$ is composite, the result just proved shows that $G$ is not simple, so it has a nontrivial proper normal subgroup $N$. Both $N$ and $G/N$ have smaller order and are solvable by induction. Since an extension of a solvable group by a solvable normal subgroup is solvable, $G$ is solvable. $\square$
...
- **Additional source:** [S2, Ch. I, Ex. 27, printed p. 77, PDF p. 92]; Lang's solvability conclusion is deduced by induction from the Artin simple-group classification.
